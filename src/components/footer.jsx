...
const SOCIALS = [
  { href: "https://x.com/taleofclaire", label: "(former Twitter)", Icon: VscTwitter },
  ...
  return (
    <footer className="w-full border-t border-white/10 bg-background px-6 py-16 sm:px-16">
      <div className="flex flex-col items-center gap-12">
        <Link href="/" className="flex w-full items-center justify-center gap-3 no-underline">
          ...
          <div className="flex flex-col items-center gap-3">
            ...
            {SOCIALS.map(({ href, label, Icon }) => (
              <a
                ...
                className="flex items-center font-semibold gap-2 font-serif text-lg text-white/80 no-underline transition-colors duration-300 hover:text-subcaption sm:text-xl"
              >
